<?php
	...
	require('./jdincfunctions/findcategoryinc.php');
	
	$csrf_password_generator = hash('sha256', "categories").CSRF_PASS_GEN;
...
<script type="text/javascript" src="./jdscripts/categoriesinc.js"></script>
    ...
    <div id='content'>
		<div id='pagetitle'>
        	<ul class='secondarynavi'>
                <li class='highlight'><?=$categoryVarsArr['name']?></li>
            </ul>
        </div>
    	<div id='spacer'></div>
		...
		<div id='maincolumn'>
        	<div class='categorynames'><?=$categoryVarsArr['name']?></div>
            <div class='categoryalbumbanners'>Category Albums:<div class='biglines'></div></div>
        	<div id='albums'>
			<?php loadAlbums($categoryID); ?>
			</div>
        </div><!--mainColumn-->
