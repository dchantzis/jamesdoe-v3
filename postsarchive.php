<?php
	...
	$csrf_password_generator = hash('sha256', "postsarchive").CSRF_PASS_GEN;
...
<script type="text/javascript" src="./jdscripts/getpostsinc.js"></script>
<script type="text/javascript" src="./jdscripts/postsarchiveinc.js"></script>
...
<body class='postsarchive'>
    ...
    <div id='content'>
		...
		<div id='maincolumn'>
        	<div class='postsarchivebanners'>posts archive</div>
            <?php getAllPostTimestamps(); ?>
		</div><!--mainColumn-->
