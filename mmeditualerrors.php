<?php
	...
	$csrf_password_generator = hash('sha256', "mmeditualerrors").CSRF_PASS_GEN;
...
<body class="mmeditualerrors">
    ...
    <div id="content">
        ...
        <div id="helpcontent">
			...
			<?php helpContentsAdm('mmeditualerrors');?>
        </div>
        ...
        <div id="maincolumn">
    		<div class='ualbanners'><span id='banner'>users action log: errors</span></div>
			<?=displayUsersActionLogEntries('error')?>
        </div><!--mainColumn-->
