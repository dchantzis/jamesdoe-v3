<?php
	...
	$csrf_password_generator = hash('sha256', "mmualeditcomments").CSRF_PASS_GEN;
    ...
    <div id="content">
    	<div id="pagetitle">
        	<ul class='secondarynavi'>
                <li>action log &gt;</li>
                <li class='highlight'>comments</li>
            </ul>
        ...
        <div id="helpcontent">
			...
			<?php helpContentsAdm('mmualeditcomments');?>
        </div>
        ...
        <div id="maincolumn">
    		<div class='ualbanners'><span id='banner'>users action log: comments</span></div>
			<?=displayUsersActionLogEntries('comment')?>
        </div><!--mainColumn-->
