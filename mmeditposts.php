...
<script type="text/javascript" src="./jdscripts/mmeditpostsinc.js"></script>
...
<body class="mmeditposts">
    ...
    <div id="content">
        ...
        <div id="helpcontent">
			...
			<?php helpContentsAdm('mmeditposts');?>
        </div>
        ...
        <div id="maincolumn">
            <?php  //unset($_SESSION['postslimit']); ?>
          	<div class='postsbanner'>posts:</div>
            <div id='postsoptions'>
				<a id='addpost' href='#'>create new post</a>
            	<div id='postoptionsline'></div>
            </div>
