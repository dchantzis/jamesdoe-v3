<?php
	...
	$csrf_password_generator = hash('sha256', "mmeditsettings").CSRF_PASS_GEN;
...
<script type="text/javascript" src="./jdscripts/mmeditsettingsinc.js"></script>
    ...
    <div id="content">
    	<div id="pagetitle">
        	<ul class='secondarynavi'>
                <li class='highlight'>settings</li>
            </ul>
        ...
        <div id="helpcontent">
			...
			<?php helpContentsAdm('mmeditsettings');?>
        </div>
        ...
        <div id="maincolumn">
    		<div class='settingsbanners'><span id='banner'>website settings:</span></div>
            <ul class='settingscategories'>
            	<?php loadProfilesAdm($profileID); ?>
                <li class='clearboth'></li>
				<?php loadAlbumsVisibilityAdm($profileID); ?>
                <li class='clearboth'></li>  
				<?php loadSettingsAdm($profileID); ?>
            </ul>
        </div><!--mainColumn-->
